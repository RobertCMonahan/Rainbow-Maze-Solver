...
class DepthFirstTest {
    ...
    void testSearchTiny() {
        ...
        boolean reachedEnd = DepthFirst.search(tinyMaze);
    ...
    void testSearchSmall() {
        ...
        boolean reachedEnd = DepthFirst.search(smaze);
        assertEquals(true, reachedEnd, "If the DepthFirst Search reached the end");
    }
    ...
    void testSearchNormal() {
        ...
        boolean reachedEnd = DepthFirst.search(nmaze);
        assertEquals(true, reachedEnd, "If the DepthFirst Search reached the end");
    }
    ...
    void testSearchBraid200() {
        ...
        boolean reachedEnd = DepthFirst.search(b200maze);
        assertEquals(true, reachedEnd, "If the DepthFirst Search reached the end");
    }
    ...
    void testSearchCombo400() {
        ...
        boolean reachedEnd = DepthFirst.search(c400maze);
        assertEquals(true, reachedEnd, "If the DepthFirst Search reached the end");
    }
    ...
    void testSearchBraid2k() {
        ...
        boolean reachedEnd = BreadthFirst.search(braid2kMaze);
